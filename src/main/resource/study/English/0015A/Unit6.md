...
|There are only four areas where many diamonds have been found.|
...
## Text B
|_&bull; The Difference between Plants and Animals_|
|---|
...
|Look up into the sky, and then down at the earth beneath your feet. It is easy enough, you think, to tell which is earth and with is sky; but if you live in the wide, open country, or near the sea, you will often find when you look far away to the place where sky and earth seem to meet, that this is a matter of some difficulty. You see only the thin blue haze, like smoke, which is the dividing line between the heavens and the earth. But just where the one ends and the other begins, you cannot tell.|
|Just so it throughout all the world of Nature. You may look at a group of cows standing under the trees or catch a bee at his early drink in a morning-glory bell, and you would laugh if any one should ask you whether you can tell an animal from a plant.|
...
|Plants are the true fairies that are forever working wonders around us. Their roots dig down into the earth and gather its treasures. Their leaves spread their broad surfaces to the air and take in its riches; and out of what they have thus gathered they produce the beautiful flowers, the delicious fruits, and the golden grain.|
...
|时/态|现在|过去|将来|过去将来|
|---|---|---|---|---|
|一般|write(s)|wrote|shall/will write|should/would write|
|进行|am/is/are writing|was/were writing|shall/will be writing|should/would be writing|
|完成|have/has written|had written|shall/will have written|should/would have written|
|完成进行|have/has been writing|had been writing|shall/will have been writing|should/would have been writing|

### 一. 一般现在时
#### 1. 表示现在经常或反复发生的动作或存在的状态

常和 often, always, usually, sometimes, every day, once a week 等时间状语连用

#### 2. 表示主语的特征/性格/能力等
#### 3. 表示客观事实或普遍真理
#### 4. 表示安排或计划好的将来发生的动作
#### 5. 在时间或条件状语从句中表示将来的动作
#### 6. 代表过去时表示某些文学作品中的情节描述,或用来引述书刊材料
### 二. 一般过去时

表示过去某时发生的动作或状态,常和表示过去的时间状语(yesterday,last week, three years ago, in 1987 等)连用

### 三. 一般将来时

在时间或条件状语从句中, 一般不用将来时, 而是用现在时

除了shall/will + 动词原形构成一般将来时,还有以下形式

#### 1. am/is/are going to + 动词原形

表示最近打算去做的事情或可能要发生的事情

#### 2. am/is/are about to + 动词原形
...
表示过去某一时间内将要发生的动作或存在的状态

与一般将来时类似,也可用 `was/were going to do` `was/were about to do` `was/were to do` 等形式表示过去某时间内计划/打算或一定要进行的动作

### 五. 现在进行时

表示现在正在进行的动作

有些动词(go come stay leave start)的现在进行时形式也可表示将来即将发生的动作

有些表示状态和感觉的动词不用于(或在某个词义上)进行时, such : hate like love believe think look mind have seem sound remain

### 六. 过去进行时

表示过去某一时刻或某段时间内正在进行的动作

与现在进行时类似 go come start stay leave 等动词的过去进行时形式可以表示过去将要发生的动作

### 七. 将来进行时

表示在将来的某一段时间正在发生的动作, 或按计划在未来将要进行的动作

### 八. 现在完成时

表示过去开始,但持续到现在的动作,或表示过去发生的动作,但对现在仍留下某种后果和影响

### 九. 过去完成时

表示过去某个时间或某个动作之前已经完成的动作, 或者表示过去某个时间开始一直延续到过去另一个时间的动作
...
表示从过去某一时间开始一直延续到现在的动作,这个动作可能刚刚结束,或者可能要继续进行下去

### 十二. 过去完成进行时

表示过去某个时间以前已经开始而又延续到过去这个时间的动作. 这个动作可能刚刚停止,也可能还在继续.

### 十三. 时态的呼应

名词从句,尤其是宾语从句中的动词时态,常受到主句影响. 时态的呼应只出现在主句谓语是过去时/过去完成时的时候

规则: 从句的谓语动词由一般现在时变成一般过去时,一般过去时变成过去完成时,一般将来时变成过去将来时.

以下不遵守时态呼应的规则:

>1. 从句的谓语表示的是一个人或物的经常性特征
>2. 从句中表示绝对过去时间的状语
